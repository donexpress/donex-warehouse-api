...
router.get("/api/v1/aos_warehouse", verifyTokenPresent, AOSWarehouseController.index);
...
router.put("/api/v1/aos_warehouse/:id", AOSWarehouseController.update);
router.delete("/api/v1/aos_warehouse/:id", verifyTokenPresent, AOSWarehouseController.remove);
